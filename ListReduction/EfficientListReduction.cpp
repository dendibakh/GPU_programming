...
Dataset Id:     5
Created:        less than a minute from now
Status: Correct solution for this dataset.
Timer Output
Kind    Location        Time (ms)       Message
Generic main.cu::75     61.585432       Importing data and creating memory on host
GPU     main.cu::89     0.219885        Allocating GPU memory.
GPU     main.cu::96     0.044513        Copying input memory to the GPU.
Compute main.cu::105    0.037394        Performing CUDA computation
Copy    main.cu::112    0.021772        Copying output memory to the CPU
GPU     main.cu::142    0.134179        Freeing GPU Memory
Logger Output
